...
- 生成：2026-09-14T07:39:36+0800
- HEAD：`c303056952b0`（§29：报告 commit 必须等于当前 HEAD）
- **OVERALL：FAIL**
...
- G03_CANONICAL_V1_REGRESSION: **PASS** `{"claims_admitted": 4540}`
...
- G06_PROCESS: **FAIL** `{"admitted": 14, "target": 80, "integrity": "PASS"}`
- G07_FLOW: **FAIL** `{"flows": 26, "flow_types": 3, "target": 30}`
...
```json
{
 ...
 "source_domains": 964,
 "entities": 21978,
 "claims_admitted": 4540,
 "evidence": 4982,
 "traditions_admitted": 17,
 "processes_admitted": 14,
 "flows_total": 26,
 "flow_types": 3,
