...
- 生成：2026-09-14T08:21:11+0800
- HEAD：`9724cd15ca2b`（§29：报告 commit 必须等于当前 HEAD）
- **OVERALL：FAIL**
...
- G03_CANONICAL_V1_REGRESSION: **PASS** `{"claims_admitted": 4546}`
...
- G07_FLOW: **FAIL** `{"flows": 30, "flow_types": 3, "target": 30}`
...
- G15_GROWTH_50CYCLE: **FAIL** `{"cycles_available": 102, "cycles_with_structural_gain": 8, "gain_rate": 0.078, "target_rate": 0.6, "circuit_healthy_rate": 0.99}`
